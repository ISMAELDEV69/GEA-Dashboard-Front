...
// ── Code Splitting Obligatorio para Vistas Pesadas (react-performance) ─────────
const Dashboard = lazy(() => import('./components/Dashboard'))
const ReclutadorDashboard = lazy(() => import('./components/dashboard/ReclutadorDashboard'))
const NominaForm = lazy(() => import('./components/NominaForm'))
const NominaCompletar = lazy(() => import('./pages/NominaCompletar'))
const AsistenciaForm = lazy(() => import('./components/AsistenciaForm'))
const AttendanceBI = lazy(() => import('./components/AttendanceBI'))
const ConsolidadoPowerBI = lazy(() => import('./components/ConsolidadoPowerBI'))
const DescuentosBI = lazy(() => import('./components/DescuentosBI'))
const MotivosBajasBI = lazy(() => import('./components/MotivosBajasBI'))
const DescuentosForm = lazy(() => import('./components/DescuentosForm'))
const DescuentosAutorizacion = lazy(() => import('./components/DescuentosAutorizacion'))
const PropuestasModule = lazy(() => import('./pages/PropuestasModule'))
const ReporteDia1 = lazy(() => import('./components/ReporteDia1'))
const ResumenCapacitacion = lazy(() => import('./components/ResumenCapacitacion'))
const CapacidadRys = lazy(() => import('./components/CapacidadRys'))
const MetasManagement = lazy(() => import('./components/MetasManagement'))
const AuditLogs = lazy(() => import('./components/AuditLogs'))
const UserManagement = lazy(() => import('./components/UserManagement'))
const EquipoReclutamiento = lazy(() => import('./pages/EquipoReclutamiento'))
const EquipoFormacion = lazy(() => import('./pages/EquipoFormacion'))
const AsignacionFormador = lazy(() => import('./pages/AsignacionFormador'))
const MotivosBajaAdmin = lazy(() => import('./components/MotivosBajaAdmin'))
const PerfilConfig = lazy(() => import('./components/PerfilConfig'))
const LegacyDashboards = lazy(() => import('./components/LegacyDashboards'))
const DashboardsAdmin = lazy(() => import('./components/DashboardsAdmin'))
const RolePermissionsAdmin = lazy(() => import('./components/RolePermissionsAdmin'))
const PostulantesTable = lazy(() => import('./components/PostulantesTable'))
...
const ALL_NAV = [
  ...
  { id: 'nomina', label: 'Bolsa Postulantes', icon: UserPlus, description: 'Ingreso masivo y registro', roles: ['admin', 'reclutador'] },
