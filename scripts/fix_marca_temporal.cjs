...
if (!content.includes('parseTimestamp(')) {
  content = content.replace(/export function parseNominaRows/, parser + '\nexport function parseNominaRows')
}

// Update marca_temporal in row builder
...
console.log('Fixed marca_temporal formatting');
